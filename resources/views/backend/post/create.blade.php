...
type="button" role="tab" aria-controls="content" aria-selected="false">Nội/-strong/-heart:>:o:-((:-hDung</button>
                                </li>
                            </ul>
...
<label for="topic_id">Chủ đề</label>
                                                <select name="topic_id" id="topic_id" class="form-control">/-strong/-heart:>:o:-((:-h<option value="">--chon chủ đề--</option>
                                                    {!! $html_topic_id !!}
                                                </select>
...
@if ($errors->has('detail'))
                                            <div class="text-danger">
                                                {{ $errors->first('detail') }}/-strong/-heart:>:o:-((:-h</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
